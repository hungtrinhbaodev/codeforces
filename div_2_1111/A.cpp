...
int main() {
    ...
    while(t--) {
        int n = _read<int>();
        std::vector<int> arr = _reads<int>(n);
        ...
        _println<std::string>(std::abs(count_negative - count_positive) % 4 == 0 ? "YES" : "NO");
    }
...
/**
 * link contest: https://codeforces.com/contest/2247/problem/A
 */