...
void solve()
{
  ...
  for (const auto &q : queries)
  {
    ...
    for (int f_try = 0; f_try < _mod; f_try++)
    {
      ...
      {
        if ((f_try * static_mod + s_try) % _mod == q.target)
        {
          ...
          if (left_border1 == - 1 || left_border1 > maybe_left1) {
              left_border1 = maybe_left1;
              left_border2 = maybe_left2;
          }
          else if (left_border1 == maybe_left1 && left_border2 > maybe_left2) {
              left_border2 = maybe_left2;
          }
...
/**
 * link contest: https://codeforces.com/contest/1729/problem/F
 */
